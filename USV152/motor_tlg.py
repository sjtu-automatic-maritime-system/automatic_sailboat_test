...
RTU_port = '/dev/serial/by-id/usb-FTDI_FT232R_USB_UART_AL00WA21-if00-port0'
...
if __name__ == "__main__":
    ...
    try:
        ...
        dev_pro = MsgDevice()
        dev_pro.open()
        dev_pro.sub_connect('tcp://192.168.1.60:55202') #receive rpm from veristand
        dev_pro.pub_bind('tcp://0.0.0.0:55203') #send information to veristand

        # Connect to joystick
        dev_joy = MsgDevice()
        dev_joy.open()
        dev_joy.sub_connect('tcp://192.168.1.60:55201') #receive rpm from joystick
