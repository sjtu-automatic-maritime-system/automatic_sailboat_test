...
#URL_MovingStation = "socket://192.168.1.100:40000"
URL_MovingStation = "socket://192.168.1.102:40000"
...
ORIGIN_LAT = 31.028062686119693
ORIGIN_LON = 121.43831349728798
...
class GNSS:
	...
	def publish(self,dev_pro):
		self.dev = dev_pro
		# print(self.posx,self.posy,self.stdx,self.stdy)
...
if __name__ == "__main__":
    gps_url = URL_MovingStation
    try:
        dev_pro = MsgDevice()
        dev_pro.open()
        dev_pro.pub_bind('tcp://0.0.0.0:55204')
     
        gps = GNSS(gps_url)
        gps.write(MS_COMMANDS)
